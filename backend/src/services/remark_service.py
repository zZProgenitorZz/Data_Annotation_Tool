...
class RemarkService:
    ...
    # get all remarks
    async def get_all_remarks(self, current_user: UserDto | None = None) -> List[RemarkDTO]:
    ...
    # Delete remark
    async def delete_remark(self, remark_id: str, current_user: UserDto | None = None) -> bool:
    ...
    # Update remark
    async def update_remark(self, remark_id: str, updated_remark: RemarkUpdate, current_user: UserDto | None = None) -> bool:
